...
// 1.  When the user submits their to-do list item  ... when they hit Enter)
...
//   * Append the list item to our ordered to-do list
  $('.items').append('<div class="lineItem"><input type="checkbox" name="toDoItem">' + task + '<button class="erase">Delete</button>' + '<br></div>')
